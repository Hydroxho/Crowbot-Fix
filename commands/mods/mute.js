...
module.exports = {
    ...
    run: async (client, message, args, prefix, color) => {
        ...
        if (client.config.owner.includes(message.author.id) || db.get(`ownermd_${client.user.id}_${message.author.id}`) === true || perm) {
            ...
            function mute(user, authorcooldown, muterole, time = null) {
            ...
            if (args[0]) {
                ...
                if (!muterole) {
                    ...
                    message.guild.channels.cache.forEach(channel => channel.updateOverwrite(muterole, {
                        SEND_MESSAGES: false,
                        CONNECT: false,
                        ADD_REACTIONS: false
                    }, "Muterole"));
                ...
                mute(user, authorcooldown, muterole, muteTime);
